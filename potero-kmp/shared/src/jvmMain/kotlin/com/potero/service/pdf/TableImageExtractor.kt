...
/**
 * Extracts table images from PDF files based on GROBID bounding boxes.
 *
 * Strategy:
 ...
 *
 * Note: For MVP, we render tables as images rather than extracting data.
 * This preserves the exact visual layout of complex academic tables.
 */
class TableImageExtractor {

    companion object {
        private const val DPI = 300f // High quality for tables
        private const val BBOX_PADDING_PERCENT = 0.10 // 10% padding around bbox
    }

    /**
     * Extract table region from PDF and save as PNG image.
     *
